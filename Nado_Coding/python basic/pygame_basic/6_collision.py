...
background = pygame.image.load(
    "C:\\Github Projects\\programming\\Python\\example\\pygame_basic\\background.png"
)

# 캐릭터 스프라이트 불러오기
character = pygame.image.load(
    "C:\\Github Projects\\programming\\Python\\example\\pygame_basic\\character.png"
)
character_size = character.get_rect(
).size  # 캐릭터의 전체 범위를 네모로 인식하는데 이때의 크기를 반환한다.
...
enemy = pygame.image.load(
    "C:\\Github Projects\\programming\\Python\\example\\pygame_basic\\enemy.png"
)
...
while running:
    ...
    ):  # pygame에서 이벤트 루프 필수 코드, 어떤 이벤트가 발생하였는지 체크
    ...
    )  # character.get_rect()는 초기 값을 계속 지니고 있어 업데이트를 해줄 필요가 있다.
